class Product {
  ...
  String? updatedAt;
  int? iV;
  Map<String, String>? specifications; // Thêm thông số kỹ thuật
  ...
  Product(
      ...
      this.updatedAt,
      this.iV,
      this.specifications}); // Thêm constructor cho specifications
  ...
  Map<String, dynamic> toJson() {
    ...
    // Chuyển specifications thành JSON
